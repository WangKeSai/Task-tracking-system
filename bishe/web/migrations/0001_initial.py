# Generated by Django 3.2 on 2023-06-13 11:58
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.SmallIntegerField(choices=[(1, '#56b8ed'), (2, '#f28033'), (3, '#ebc656'), (4, '#a2d148'), (5, '#20BFA4'), (6, '#7461c2'), (7, '#20bfa3')], default=1, verbose_name='颜色')),
                ...
                ('region', models.CharField(max_length=32, verbose_name='腾讯对象存储桶区域')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('parent', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='children', to='web.wiki', verbose_name='父文章')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('invitee', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='invites', to='web.userinfo', verbose_name='邀请者')),
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.project', verbose_name='项目')),
        ...
        migrations.AddField(
            model_name='project',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.userinfo', verbose_name='创建者'),
        ),
        migrations.CreateModel(
            name='Module',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='web.project', verbose_name='项目')),
            ],
        ),
        migrations.CreateModel(
            name='IssuesReply',
        ...
        migrations.AddField(
            model_name='issues',
            name='assign',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='task', to='web.userinfo', verbose_name='指派'),
        ),
        migrations.AddField(
            model_name='issues',
            name='attention',
        ...
        migrations.AddField(
            model_name='issues',
            name='creator',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, related_name='create_problems', to='web.userinfo', verbose_name='创建者'),
        ),
        migrations.AddField(
            model_name='issues',
            name='issues_type',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.issuestype', verbose_name='问题类型'),
        ),
        migrations.AddField(
            model_name='issues',
            name='module',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='web.module', verbose_name='模块'),
        ),
        migrations.AddField(
            model_name='issues',
            name='parent',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='文件/文件夹名称', max_length=32, verbose_name='文件夹名称')),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='web.project', verbose_name='项目')),
                ('update_user', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='web.userinfo', verbose_name='最近更新者')),
            ],
        ),
    ]
