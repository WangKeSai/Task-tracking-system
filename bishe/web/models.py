...
class PricePolicy(models.Model):
    """价格策略表"""
    title = models.CharField(max_length=68, verbose_name='标题')
    category_choices = (
        (1, "免费版"),
        (2, "收费版"),
        (3, "其他")
    ...
    person_num = models.PositiveIntegerField(verbose_name='项目成员数')
...
class ProjectUser(models.Model):
    ...
    invitee = models.ForeignKey(verbose_name='邀请者', to='UserInfo', related_name='invites', on_delete=models.DO_NOTHING)
    star = models.BooleanField(verbose_name='星标', default=False)
...
class Wiki(models.Model):
    ...
    parent = models.ForeignKey(verbose_name='父文章', to='Wiki', related_name='children', on_delete=models.DO_NOTHING, null=True, blank=True)
...
class FileRepository(models.Model):
    ...
    update_user = models.ForeignKey(verbose_name='最近更新者', to='UserInfo', on_delete=models.DO_NOTHING)
...
class Issues(models.Model):
    ...
    assign = models.ForeignKey(verbose_name='指派', to='UserInfo', related_name='task', null=True, blank=True, on_delete=models.DO_NOTHING)
    ...
    creator = models.ForeignKey(verbose_name='创建者', to='UserInfo', related_name='create_problems', on_delete=models.DO_NOTHING)
...
class IssuesType(models.Model):
    ...
    project = models.ForeignKey(verbose_name='项目', to='Project', on_delete=models.CASCADE, null=True)
